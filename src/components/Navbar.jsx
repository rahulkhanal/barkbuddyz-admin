...
const Container = styled.div`
  width: 100vw;
  height: 60px;
  background-color: rgb(127, 214, 220);
  color: black;
  z-index: 10;
`;
      ...
      <Wrapper>
        ...
        {admin && (
          <Center>
            ...
            <Center>
              <MenuItem onClick={() => navigate("/vet/")}>
                <MenuLinks className={path === "vet" ? "active" : null}>
                  <FaDog />
                  <Menu>Vet</Menu>
                </MenuLinks>
              </MenuItem>
            ...
            <Center>
              <MenuItem onClick={() => navigate("/trainer/")}>
                <MenuLinks className={path === "trainer" ? "active" : null}>
                  <GroupOutlinedIcon />
                  <Menu>Trainer</Menu>
                </MenuLinks>
              </MenuItem>
