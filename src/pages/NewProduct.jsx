      ...
      <Wrapper>
        <Form onSubmit={handleSubmit}>
          ...
          <Category>
            ...
            <CategoryLabel htmlFor="pets">PETS</CategoryLabel>
            <CategoryInput
              type="radio"
              name="category"
              id="food"
            ...
            <CategoryLabel htmlFor="women">FOOD</CategoryLabel>
            <CategoryInput
              type="radio"
              name="category"
              id="essentials"
              ...
              onChange={handleInput}
            />
            <CategoryLabel htmlFor="women">ESSENTIALS</CategoryLabel>
            ...
            <CategoryInput
              ...
              onChange={handleInput}
            />
            <CategoryLabel htmlFor="women">HYGIENE</CategoryLabel>
